...
const meCourseMeta: Unit[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'u3-L1b', title: 'Stress & Strain Fundamentals II', description: 'Stress & Strain Fundamentals: intermediate concepts and calculations.', icon: '📝', xpReward: 20, questions: [] },
      { id: 'u3-L1c', title: 'Stress & Strain Fundamentals III', description: 'Stress & Strain Fundamentals: advanced applications and edge cases.', icon: '📝', xpReward: 20, questions: [] },
      ...
      { id: 'u3-L2b', title: 'Beam Bending II', description: 'Beam Bending: intermediate concepts and calculations.', icon: '📝', xpReward: 25, questions: [] },
      { id: 'u3-L2c', title: 'Beam Bending III', description: 'Beam Bending: advanced applications and edge cases.', icon: '📝', xpReward: 25, questions: [] },
      ...
      { id: 'u3-L3b', title: 'Shear & Bending Diagrams II', description: 'Shear & Bending Diagrams: intermediate concepts and calculations.', icon: '📝', xpReward: 25, questions: [] },
      { id: 'u3-L3c', title: 'Shear & Bending Diagrams III', description: 'Shear & Bending Diagrams: advanced applications and edge cases.', icon: '📝', xpReward: 25, questions: [] },
      ...
      { id: 'u3-L4b', title: 'Torsion II', description: 'Torsion: intermediate concepts and calculations.', icon: '📝', xpReward: 25, questions: [] },
      { id: 'u3-L4c', title: 'Torsion III', description: 'Torsion: advanced applications and edge cases.', icon: '📝', xpReward: 25, questions: [] },
      ...
      { id: 'u3-L5b', title: 'Lesson II', description: 'Lesson: intermediate concepts and calculations.', icon: '📝', xpReward: 30, questions: [] },
      { id: 'u3-L5c', title: 'Lesson III', description: 'Lesson: advanced applications and edge cases.', icon: '📝', xpReward: 30, questions: [] },
      ...
      { id: 'u3-L6b', title: 'Failure Theories II', description: 'Failure Theories: intermediate concepts and calculations.', icon: '📝', xpReward: 30, questions: [] },
      { id: 'u3-L6c', title: 'Failure Theories III', description: 'Failure Theories: advanced applications and edge cases.', icon: '📝', xpReward: 30, questions: [] },
      ...
      { id: 'u3-L7b', title: 'Column Buckling & Pressure Vessels II', description: 'Column Buckling & Pressure Vessels: intermediate concepts and calculations.', icon: '📝', xpReward: 30, questions: [] },
      { id: 'u3-L7c', title: 'Column Buckling & Pressure Vessels III', description: 'Column Buckling & Pressure Vessels: advanced applications and edge cases.', icon: '📝', xpReward: 30, questions: [] },
