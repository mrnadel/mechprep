  ...
  lessons: [
    // ===== LESSON 0: Small Money, Big Difference (bridge from Unit 0) =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: "Money works in time: 1/day = 30/month = 365/year. Small daily habits become big numbers over time.",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: '20 would be 10 workdays, but there are 20 workdays in a month.',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: '500 would require saving about 17/day, not 5.',
    ...
    // ===== LESSON 1: The Latte Factor (HOOK) =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: "Want to see the real cost of any daily habit? Multiply by 365: 3/day = 1,095/year, 10/day = 3,650/year.",
        ...
        },
        {
          ...
          explanation: "The Latte Factor isn't about giving everything up. Once you see the yearly cost, you choose what's worth it and cut what's not.",
    ...
    // ===== LESSON 2: Where It All Goes (follows Latte Factor naturally) =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: '46 is just one month of subscriptions, not a full year.',
    ...
    // ===== LESSON 4: The Paycheck Reality (heavier content, earned by now) =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: "Taxes are money everyone pays to the government, funding roads, hospitals, schools, and police. The government takes it from your paycheck automatically.",
        ...
        },
        {
          ...
          explanation: "Gross pay is your full salary before anything is removed. Net pay is what actually lands in your bank after taxes and deductions.",
      ...
      questions: [
        {
          ...
          explanation: "A need is something you can't function without: food, shelter, basic transportation. A want is everything else, and your brain is great at disguising wants as needs.",
        ...
        },
        {
          ...
          explanation: "The basic version of most things covers the need, while the premium upgrade is the want. Companies are great at making upgrades feel like necessities.",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Walking may not be feasible for most commutes, so basic transportation is a real need.',
        ...
        },
        {
          ...
          explanation: "Some things depend on context: internet for remote work is a need, but just for TikTok it's a want. The same item can be a need for one person and a want for another.",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Desktops and laptops are both valid work tools — the device type does not determine need.',
    ...
    // ===== LESSON 6: Your First Budget =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: "Split your net pay into three buckets: 50% for needs (rent, groceries, bills), 30% for wants (eating out, entertainment), and 20% for savings and debt.",
        ...
        },
        {
          ...
          explanation: "On payday, auto-transfer 20% to savings and set up auto-pay for bills. What's left is your guilt-free wants money.",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Banks do not give higher interest rates just for setting up auto-transfers.',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'You do have 200 left, not zero — 3,000 minus 2,800 in expenses leaves 200.',
    ...
    // ===== LESSON 7: Paycheck & Budget Blitz (Speed Round - test before closer) =====
    {
      ...
      speedQuestions: [
        ...
        {
          id: "pf-u1-L8-SQ13",
          question: "5/day on coffee equals how much per year?",
          options: ["1,825", "500", "365", "600"],
          correctIndex: 0,
        },
        {
          id: "pf-u1-L8-SQ14",
          question: "An emergency fund should cover:",
          options: ["Vacations", "Unexpected expenses", "Daily coffee", "New clothes"],
          correctIndex: 1,
        },
        {
          id: "pf-u1-L8-SQ15",
          question: "Variable expenses _____ each month.",
          options: ["Stay the same", "Change", "Disappear", "Double"],
          correctIndex: 1,
        },
      ],
    },
      ...
      questions: [
        {
          ...
          explanation: "Most people spend first and save what's left, but there's never anything left. Flip it: save first, spend the rest.",
        ...
        },
        {
          ...
          explanation: "Start with just 500 in an emergency fund to cover a car repair, medical bill, or broken phone. Without it, one surprise puts you into debt.",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Saving "whatever is left" means you have no target, so you will likely save nothing.',
        ...
        },
        {
          ...
          explanation: "Start with 25 per paycheck because the habit matters more than the amount. Once it feels normal, increase it to 50, then 100.",
