    ...
    // ===== LESSON 1: The Paycheck Reality =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          hint: "A job paying 5,000/month might only put 3,500 to 4,000 in your bank.",
        },
        {
          id: "pf-u1-L1-Q4",
          type: "fill-blank",
      ...
      questions: [
        {
          ...
          explanation: "Most people can't explain 30-40% of their spending. Small purchases add up without you noticing. The fix? Track your spending for one month.",
        ...
        },
        {
          ...
          explanation: "Each subscription feels small, 10 here, 15 there. But the average person spends 200 to 300/month on subscriptions without realizing it. They auto-renew, so you forget they exist.",
        ...
        },
        {
          ...
          correctBuckets: [0, 1, 0, 1, 0, 1],
          explanation: "You can cancel a gym membership or streaming service today. Rent, electricity, and car insurance are locked in or essential.",
        },
      ],
    },
    ...
    // ===== LESSON 3: Needs vs Wants =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          buckets: ["Need", "Want"],
          correctBuckets: [0, 1, 0, 1, 0, 1],
          explanation: "Textbooks, a bus pass, and basic groceries are essential. Coffee shops, food delivery, and new headphones can be skipped when money's tight.",
        },
        {
          id: "pf-u1-L3-Q7",
          type: "match-pairs",
    ...
    // ===== LESSON 4: The Latte Factor =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correctIndex: 0,
          explanation: "6 × 250 workdays = 1,500 per year. That's a vacation or a new laptop, all spent on sandwiches.",
        },
        {
          id: "pf-u1-L4-Q2",
          type: "true-false",
          ...
          correctAnswer: true,
          explanation: "3 × 365 = 1,095 per year. Even 'just 3 bucks' adds up to four figures when it's every day.",
        },
        {
          id: "pf-u1-L4-T2",
          type: "teaching",
          question: "🧮 The ×365 Trick",
          explanation: "Want to see the real cost of a daily habit? Multiply by 365. 3/day = 1,095/year. 10/day = 3,650/year. Simple math, shocking results.",
        ...
        },
        {
          ...
          correctMatches: [0, 1, 2, 3],
          explanation: "Just multiply by 365. Even 2/day becomes 730/year. At 15/day, you're spending over 5,000/year.",
        },
        {
          id: "pf-u1-L4-Q4",
          type: "fill-blank",
        ...
        },
        {
          ...
          correctIndex: 0,
          explanation: "Before: 5 × 365 = 1,825/year. After: (5 × 52) + (0.50 × 4 × 52) = 260 + 104 = 364/year. Savings: about 1,460. Roughly 936 with 3 days out.",
        },
        {
          id: "pf-u1-L4-Q6",
          type: "sort-buckets",
          ...
          correctBuckets: [0, 1, 0, 1, 0, 1],
          explanation: "Latte factor expenses are small, daily, and feel insignificant. Rent, insurance, and electric bills are fixed costs you can't eliminate with a habit change.",
        },
        {
          id: "pf-u1-L4-Q7",
          type: "true-false",
        ...
        },
        {
          ...
          correctIndex: 0,
          explanation: "Before: 10 × 365 = 3,650/year. After: (10 × 2 × 52) + (3 × 5 × 52) = 1,040 + 780 = 1,820/year. Savings: about 1,830.",
        },
      ],
    },
    ...
    // ===== LESSON 5: Your First Budget =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correctMatches: [0, 1, 2, 3],
          explanation: "50% needs, 30% wants, 20% savings. Taxes are already taken out before you got paid. Remember gross vs net?",
        },
        {
          id: "pf-u1-L5-Q7",
          type: "true-false",
    ...
    // ===== LESSON 6: Pay Yourself First =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correctMatches: [0, 1, 2, 3],
          explanation: "Zero savings means any surprise puts you in debt. 500 handles small emergencies. 3 months means you can survive job loss.",
        },
        {
          id: "pf-u1-L6-Q7",
          type: "true-false",
        ...
        },
        {
          ...
          correctIndex: 0,
          explanation: "50 × 12 = 600. A solid emergency fund from a tiny monthly habit.",
        },
      ],
    },
