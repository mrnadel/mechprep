  ...
  lessons: [
    // ===== LESSON 1: Retirement Math: Your Future Self Needs You =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Those first 10 years of compound growth are incredibly powerful',
    ...
    // ===== LESSON 3: IRA: Roth vs Traditional Showdown =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Jamie is in a LOW tax bracket now (12%) and expects to be in a HIGHER bracket later (22%+)',
      ...
      questions: [
        {
          ...
          explanation: "Many employers match your 401(k) contributions, typically 50% of what you put in up to 6% of your salary. This is free money you should never leave on the table.",
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            "Wait until 67; claiming early while earning $70K permanently reduces her benefit",
          ],
          correctIndex: 3,
          ...
          distractorExplanations: {
            0: 'If Maria claims at 62 while earning $70K, her benefit gets reduced by 30% permanently AND a portion gets temporarily withheld because her earnings ...',
        ...
        },
        {
          ...
          options: ["Age 62", "Age 65", "Age 67", "Age 70"],
          matchTargets: ["~30% less than full benefit", "~13% less than full benefit", "Full benefit amount", "~24% more than full benefit"],
          correctMatches: [0, 1, 2, 3],
          explanation: "62 = reduced (30% less). 65 = still reduced. 67 = full amount. 70 = maximum (24% more). Each year of delay adds roughly 8%.",
        },
      ],
    },
    ...
    // ===== LESSON 7: Starting Late? Here's the Plan =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'David should get the full match (instant 50% return',
    ...
    // ===== LESSON 8: The 4% Rule: How Much Is Enough? =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: "The 4% Rule has critics: some say it's too conservative, others say it's too aggressive for today's lower expected returns. It's a starting point, not a rigid rule.",
    ...
    // ===== LESSON 9: Catch-Up Contributions After 50 =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: "At 50, you still have 15-17 years until traditional retirement. At 8% average returns, $7,500/year extra in your 401(k) for 15 years grows to about $215,000.",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Karen can afford to max out. Contributing $30,500/year to her 401(k) (including catch-up) plus $8,000 to a Roth IRA = $38,500/year',
      ...
      questions: [
        {
          ...
          explanation: "You've learned the tools: 401(k), IRA, employer match, the 4% Rule, and catch-up contributions. Now it's time to put it all together.",
        ...
        },
        {
          ...
          explanation: "Rough savings milestones: 1x your annual salary by 30, 3x by 40, 6x by 50, and 10x by 67. Even if you're behind, knowing the target helps you plan.",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'The #1 wealth-building habit: when you get a raise, save at least half of it',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Start now, automate, increase with raises',
    ...
    // ===== LESSON 13: Retirement Accounts Speed Drill (Speed Round) =====
    {
      ...
      speedQuestions: [
        ...
        {
          id: "pf-u10-L13-SQ14",
          question: "Social Security full retirement age is currently:",
          options: ["62", "65", "67", "70"],
          correctIndex: 2,
        },
        {
          id: "pf-u10-L13-SQ15",
          question: "An HSA offers _____ tax benefits:",
          options: ["Single", "Double", "Triple", "No"],
          correctIndex: 2,
        },
      ],
    },
