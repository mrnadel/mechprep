  ...
  lessons: [
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            "Name the competitor's $80 price and say you'll switch unless they match it",
      ...
      questions: [
        {
          ...
          explanation: "Money is the #1 thing couples fight about, not because money is complicated, but because two people have different money stories and fears.",
          hint: "The goal is to understand each other's money values and find a system that works for both.",
        },
        {
          id: "pf-u12-L3-T2",
          type: "teaching",
          question: "Three Common Systems",
          explanation: "Couples typically merge finances fully, keep them fully separate, or use a hybrid with shared and personal accounts. No single approach is best; pick what fits your relationship.",
        },
        {
          id: "pf-u12-L3-Q1",
          type: "category-swipe",
      ...
      questions: [
        {
          ...
          explanation: "Most money habits are formed by age 7. Early financial education is one of the most impactful gifts you can give a child.",
        },
        {
          id: "pf-u12-L4-T2",
          type: "teaching",
          question: "Learning by Doing",
          explanation: "The best money lessons happen naturally through everyday activities. Grocery shopping, allowance decisions, and explaining trade-offs teach more than lectures.",
        },
        {
          id: "pf-u12-L4-Q1",
          type: "match-pairs",
      ...
      questions: [
        {
          ...
          explanation: "If your single job disappears tomorrow, your income goes to zero instantly. Multiple income streams provide a safety net.",
        },
        {
          id: "pf-u12-L6-T2",
          type: "teaching",
          question: "Active vs Passive Income",
          explanation: "Active income requires your time (freelancing, tutoring). Passive income earns while you sleep (dividends, rental income with a manager).",
        },
        {
          id: "pf-u12-L6-Q1",
          type: "category-swipe",
      ...
      questions: [
        {
          ...
          explanation: "Someone earning $200K/year with $300K in debt is poorer than someone earning $50K/year with $100K saved. Income is what flows in, but net worth is what stays.",
        },
        {
          id: "pf-u12-L7-T2",
          type: "teaching",
          question: "The Net Worth Formula",
          explanation: "Net worth = total assets minus total liabilities. Track this number quarterly and watch it grow over time.",
        },
        {
          id: "pf-u12-L7-Q1",
          type: "category-swipe",
      ...
      questions: [
        {
          ...
          explanation: "Many advisors earn commissions by selling products, not by growing your wealth. Only fee-only fiduciary advisors are legally required to put your interests first.",
      ...
      questions: [
        {
          ...
          explanation: "Your beliefs about money control your financial behavior more than any budget. If you grew up hearing 'money is evil,' your subconscious may sabotage wealth-building.",
        },
        {
          id: "pf-u12-L10-T2",
          type: "teaching",
          question: "Rewriting Your Money Story",
          explanation: "The first step is noticing your limiting beliefs. Once you identify them, you can consciously replace them with empowering ones.",
        },
        {
          id: "pf-u12-L10-Q1",
          type: "category-swipe",
    ...
    // ===== SPEED ROUND: Advanced Finance Blitz =====
    {
      ...
      speedQuestions: [
        ...
        {
          id: "pf-u12-L15-SQ13",
          question: "A fiduciary advisor must:",
          options: ["Sell you products", "Act in your best interest", "Charge no fees", "Guarantee returns"],
          correctIndex: 1,
        },
        {
          id: "pf-u12-L15-SQ14",
          question: "Kids start forming money habits by age:",
          options: ["3", "7", "12", "18"],
          correctIndex: 1,
        },
        {
          id: "pf-u12-L15-SQ15",
          question: "A limiting money belief is:",
          options: ["A budget rule", "A negative assumption about money", "A savings target", "A tax law"],
          correctIndex: 1,
        },
      ],
    },
