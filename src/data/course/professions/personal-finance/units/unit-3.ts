...
export const unit3: Unit = {
  ...
  lessons: [
    // ===== LESSON 1: Debt Is a Tool, Not a Monster =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: "Debt itself isn't bad. A hammer can build a house or break a window, and it depends on how you use it.",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'The right question is about long-term value',
        ...
        },
        {
          ...
          explanation: "Good debt builds your future (home, education, business). Bad debt funds consumption: things you use up or that depreciate fast while the debt remains.",
        },
        {
          id: "pf-u3-L1-Q8",
          type: "scenario",
          ...
          distractorExplanations: {
            0: 'Using savings plus a low-interest loan minimizes borrowing costs',
      ...
      questions: [
        {
          ...
          hint: "Try this now: list all your debts with their interest rates on a piece of paper, from highest rate to lowest.",
        },
        {
          id: "pf-u3-L2-T2",
          type: "teaching",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'The correct answer is About 270 (due to compounding), not About 24',
    ...
    // ===== LESSON 3: Credit Cards: The Double-Edged Sword =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Interest is the cash cow. People carrying balances pay 18-28% interest on every dollar owed',
        ...
        },
        {
          ...
          explanation: "Paying in full is the only way to win. Paying more than minimum is damage control, minimums trap you for years, and missing payments triggers late fees and penalty rates.",
        },
        {
          id: "pf-u3-L3-Q9",
          type: "multi-select",
          ...
          explanation: "Grace periods are 21-30 days, offer zero interest on full payment, and are required by law. But if you carry ANY balance from last month, you lose the grace period on new purchases too.",
        },
      ],
    },
    ...
    // ===== LESSON 4: Student Loans Survival Guide =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Income-driven repayment (IDR) caps your monthly payment at a percentage of your discretionary income',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'All options get you a degree, but the state school minimizes debt, uses federal loans with better protections, and keeps total borrowing manageable',
    ...
    // ===== LESSON 5: Car Loans: The Dealer's Game =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Dealer A: 350 × 84 = 29,400 total. Dealer B: 450 × 60 = 27,000 total',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'The certified used car gives you reliability at a lower price, shorter loan term, and total cost of about 19,200',
        ...
        },
        {
          ...
          explanation: "Pre-approval, price research, total budget planning, and a down payment give you all the power. Letting the dealer run your credit first puts them in control of the negotiation.",
        },
        {
          id: "pf-u3-L5-Q9",
          type: "slider-estimate",
    ...
    // ===== LESSON 6: The Minimum Payment Trap =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          hint: "Try this now: check your latest credit card statement for the 'minimum payment warning' box that shows total payoff time.",
        },
        {
          id: "pf-u3-L6-Q1",
          type: "multiple-choice",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'At 280/month, you\'d pay off the 4,000 in about 17 months and pay roughly 700 in interest',
    ...
    // ===== LESSON 7: Snowball vs Avalanche: Pick Your Fighter =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Snowball = smallest balance first. The logic is psychological: quick wins create momentum and motivation to keep going',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'If motivation is your problem, the snowball is your answer',
    ...
    // ===== LESSON 8: Consolidation & Refinancing =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'The 240 fee saves you roughly 2,000 in interest IF you pay it off in 15 months',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Saving 1% on interest sounds good, but refinancing federal loans to private means losing income-driven repayment, deferment, forbearance, and forgi...',
    ...
    // ===== LESSON 9: When Borrowing Makes Sense =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'This passes the framework easily: builds earning power (+25K/year), rate is reasonable (8%), payments are comfortable (226/month), and the value (h...',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'The refurbished laptop meets the need at the lowest cost with zero debt',
    ...
    // ===== LESSON 10: Debt-Free Victory Plan =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Aggressive repayment (500/month) pays about 270 in interest total',
        ...
        },
        {
          ...
          steps: [
            ...
            "Celebrate debt freedom and redirect payments to savings and goals",
          ],
          correctOrder: [0, 1, 2, 3, 4],
      ...
      timelineStages: [
        ...
        },
        {
          ...
          choices: [
            ...
            {
              text: "Yes, slow down and save the extra money instead",
              nextStageId: "pf-u3-L11-TS5",
              impact: "Saving while carrying debt can work if the savings returns exceed the loan rate, but it's risky and adds complexity.",
              optimal: false,
            },
          ],
        },
        {
          ...
          choices: [
            ...
            {
              text: "Pay off the $3K and save the rest for future goals",
              nextStageId: "pf-u3-L11-TS6",
    ...
    // ===== SPEED ROUND: Debt Terms Blitz =====
    {
      id: "pf-u3-L13",
      title: "Debt Terms Blitz",
      description: "Race the clock on interest rates, repayment strategies, and debt vocabulary.",
      icon: "⚡",
      type: "speed-round",
      xpReward: 20,
      questions: [],
      ...
      speedQuestions: [
        {
          ...
          options: ["Annual Payment Rate", "Annual Percentage Rate", "Average Pay Rate", "Adjusted Prime Rate"],
          correctIndex: 1,
        },
        {
          id: "pf-u3-L13-SQ2",
          question: "The snowball method pays off debts by:",
          options: ["Highest interest first", "Smallest balance first", "Newest first", "Random order"],
          correctIndex: 1,
        },
        {
          id: "pf-u3-L13-SQ3",
          question: "The avalanche method targets:",
          options: ["Smallest balance first", "Highest interest first", "Largest balance first", "Oldest debt first"],
          correctIndex: 1,
        },
        {
          id: "pf-u3-L13-SQ4",
          question: "A credit card grace period is:",
          options: ["Extra time to pay", "Interest-free days after billing", "A late fee waiver", "A credit limit increase"],
          correctIndex: 1,
        },
        {
          id: "pf-u3-L13-SQ5",
          question: "Paying only the minimum on credit cards:",
          options: ["Saves money", "Keeps you in debt longer", "Improves your score fast", "Lowers your rate"],
          correctIndex: 1,
        },
        {
          id: "pf-u3-L13-SQ6",
          question: "Consolidation means:",
          options: ["Ignoring debt", "Combining debts into one", "Declaring bankruptcy", "Paying extra"],
          correctIndex: 1,
        },
        {
          id: "pf-u3-L13-SQ7",
          question: "Federal student loans offer:",
          options: ["No interest", "Income-driven repayment plans", "Automatic forgiveness", "No credit check"],
          correctIndex: 1,
        },
        {
          id: "pf-u3-L13-SQ8",
          question: "Good debt typically:",
          options: ["Has high interest", "Builds value over time", "Requires no repayment", "Is always small"],
          correctIndex: 1,
        },
        {
          id: "pf-u3-L13-SQ9",
          question: "Refinancing replaces a loan with:",
          options: ["More debt", "A new loan at better terms", "A credit card", "A gift"],
          correctIndex: 1,
        },
        {
          id: "pf-u3-L13-SQ10",
          question: "Compound interest on debt means:",
          options: ["Interest stays flat", "You pay interest on interest", "Your rate drops", "Payments shrink"],
          correctIndex: 1,
        },
        {
          id: "pf-u3-L13-SQ11",
          question: "A $1,000 card at 20% APR with minimums takes roughly:",
          options: ["1 year", "3 years", "5+ years", "6 months"],
          correctIndex: 2,
        },
        {
          id: "pf-u3-L13-SQ12",
    ...
    // ===== REVIEW LESSON: Units 0-3 Review =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Automation works because you never see the money in your checking account, so you never miss it',
