    ...
    // ===== LESSON 1: Checking vs Savings: What Goes Where =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'When your emergency fund sits in checking right next to your spending money, your brain treats it all as spendable',
    ...
    // ===== LESSON 2: Banks vs Credit Unions vs Online =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Maya needs cash deposit access (credit union for checking) AND high interest (online bank for savings)',
    ...
    // ===== LESSON 3: Fee Graveyard: Stop Losing Money =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Your bank charges $3 AND the ATM owner charges $3.50, so that $60 cash cost $66.50 total',
    ...
    // ===== LESSON 4: Digital Wallets & P2P Payments =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'For large purchases from strangers, cash is king: meet in person, inspect the item, and pay on the spot',
    ...
    // ===== LESSON 5: Banking Safety & Fraud Defense =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: '2FA means even if someone steals your password, they STILL can\'t get in without the second factor, usually a code sent to your phone or generated b...',
    ...
    // ===== LESSON 6: Taxes Aren't Theft (Here's Why) =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'FICA stands for Federal Insurance Contributions Act: 7.65% of your paycheck (6.2% Social Security + 1.45% Medicare), and your employer matches it',
    ...
    // ===== LESSON 7: Tax Brackets Aren't What You Think =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: '$50,000 - $47,151 = $2,849, the only portion taxed at 22%',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Your coworker is wrong: only about $3,850 of the raise hits the 22% bracket, costing roughly $385 in extra tax',
    ...
    // ===== LESSON 8: W-2 vs 1099: Know Your Form =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'As a 1099, you pay an extra ~7.65% in self-employment tax and don\'t get benefits',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Jordan owes both income tax AND 15.3% self-employment tax on that $12,000 in freelance income',
    ...
    // ===== LESSON 9: The Standard Deduction Shortcut =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'David\'s itemized deductions ($9,700) are less than the standard deduction ($14,600)',
    ...
    // ===== LESSON 10: Tax Credits: Free Money You're Missing =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'A deduction reduces your taxable income (indirect savings)',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Lisa\'s $5,584 in credits wipes out her $2,800 tax bill completely',
    ...
    // ===== LESSON 11: Filing Step by Step =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'An extension gives you until October 15 to file, and it\'s free and automatic',
    ...
    // ===== LESSON 12: 5 Tax Mistakes That Cost You =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'The IRS receives a copy of every 1099 issued and automatically matches it to your return',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Filing early gives you time to catch errors, double-checking prevents typos, and reporting all income avoids the biggest audit trigger',
