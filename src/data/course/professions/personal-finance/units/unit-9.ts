...
export const unit9: Unit = {
  ...
  lessons: [
    // ===== LESSON 1: Renting vs Buying: The Real Math =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: "You've heard it a million times: \"Why rent when you could build equity?\" But that advice ignores a LOT of costs. When you buy a home, you also pay property taxes, insurance, maintenance, HOA fees, closing costs, and interest.",
          hint: "Try this now: check what homes cost in your area on Zillow or Redfin and compare to your current monthly rent.",
        },
        {
          id: "pf-u9-L1-T2",
          type: "teaching",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Purchase price: $350,000. Sale price: $365,000',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'With only a 2-3 year timeline, Jake would pay $10,000-$17,000 in closing costs to buy plus $18,000-$21,000 to sell',
    ...
    // ===== LESSON 2: Mortgage 101: What You're Signing =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'At 7% over 30 years, you\'d pay roughly $419,000 in interest on a $300,000 loan',
    ...
    // ===== LESSON 3: Down Payments & Closing Costs =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'While all options get you into a home, saving 20% avoids PMI entirely, which saves $1,200-$3,600/year for potentially 5-10+ years',
      ...
      questions: [
        {
          ...
          explanation: "The bank will approve you for WAY more than you should spend. Their calculation doesn't account for your actual lifestyle: car payments, subscriptions, food, or emergencies.",
        ...
        },
        {
          ...
          explanation: "The 28/36 rule: spend no more than 28% of gross income on housing (PITI) and no more than 36% on all debt combined. At $6,000/month gross, that's max $1,680 for housing and $2,160 for total debt.",
          hint: "Try this now: calculate 28% of your gross monthly income to see the maximum housing payment you could afford.",
        },
        {
          id: "pf-u9-L4-Q1",
          type: "multiple-choice",
          ...
          distractorExplanations: {
            0: 'The correct answer is $1,960, not $1,400',
      ...
      questions: [
        {
          ...
          explanation: "Buying a home involves about 10 major steps and typically takes 2-6 months. The roadmap: check finances, get pre-approved, find an agent, house hunt, make an offer, negotiate, inspect, secure your mortgage, do a final walkthrough, and close.",
        ...
        },
        {
          ...
          explanation: "Check finances and get pre-approved first, then hunt. When you find a home: offer, inspect, close. Skipping pre-approval is like car shopping without knowing your budget.",
        },
        {
          id: "pf-u9-L5-Q2",
          type: "multiple-choice",
          ...
          distractorExplanations: {
            0: 'Pre-approval does two things: tells YOU how much you can actually borrow, and tells SELLERS you\'re financially ready',
        ...
        },
        {
          ...
          options: [
            ...
            "Keep the inspection contingency; hidden problems in a 40-year-old home are too risky",
          ],
          correctIndex: 3,
          ...
          distractorExplanations: {
            0: 'On a 40-year-old home, there could be $50,000+ in hidden issues (roof, foundation, plumbing, electrical)',
    ...
    // ===== LESSON 6: Property Taxes & Hidden Costs =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Home A: $320,000 x 1.2% = $3,840/year taxes, no HOA = $3,840 total',
    ...
    // ===== LESSON 7: Refinancing: When It Makes Sense =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: "Divide your closing costs by your monthly savings to find your breakeven point. If refinancing costs $6,000 and saves $200/month, the breakeven is 30 months.",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: '$8,000 / $250/month = 32 months = 2 years and 8 months',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Breakeven: $7,500 / $320 = ~23 months (under 2 years)',
      ...
      questions: [
        {
          ...
          explanation: "People love saying \"my house is my best investment,\" but historically, home prices appreciate only 3-4% per year on average. That roughly matches inflation.",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'The home gained $15,000 in value (5% of $300,000)',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Friend A: $300,000 x 1.035^10 = ~$423,000',
    ...
    // ===== LESSON 9: Rental Properties: Landlord Math =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Revenue: $2,200. Expenses: $1,200 + $350 + $220 + $130 + $220 = $2,120',
    ...
    // ===== LESSON 10: REITs: Real Estate Without the Headaches =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: "Physical property gives you leverage, control, tax benefits (depreciation, 1031 exchanges), and potentially higher returns. REITs give you liquidity, zero management, and instant diversification.",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Tom specifically wants simplicity and diversification',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'A broad REIT index fund gives you instant diversification across hundreds of properties and sectors, low fees, high liquidity, and a proven track r...',
    ...
    // ===== LESSON 11: House Hacking: Live Free-ish =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          steps: [
            "Save for down payment and get pre-approved",
            "Search for 2-4 unit properties in your area",
            "Run the numbers (mortgage vs potential rent)",
            "Move in and prepare units for tenants",
            "Screen tenants and sign leases",
          ],
          correctOrder: [0, 1, 2, 3, 4],
          explanation: "Save and get pre-approved first, then search. Run the numbers BEFORE making an offer. Move in, prep units, then carefully screen tenants.",
        },
        {
          id: "pf-u9-L11-Q5",
          type: "fill-blank",
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'Down payment ($9,800) + closing costs ($5,000) = $14,800',
        ...
        },
        {
          ...
          distractorExplanations: {
            0: 'A fourplex with FHA financing is the holy grail: minimal cash down (3.5%), three rental units generating income, and owner-occupancy qualifies for ...',
    ...
    // ===== SPEED ROUND: Real Estate Terms Blitz =====
    {
      id: "pf-u9-L15",
      title: "Real Estate Terms Blitz",
      description: "Race the clock on mortgages, buying, and property investment terms.",
      icon: "\u26A1",
      type: "speed-round",
      xpReward: 20,
      questions: [],
      ...
      speedQuestions: [
        {
          ...
          options: ["Rate changes yearly", "Rate never changes", "Rate follows inflation", "No interest charged"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ2",
          question: "PMI is required when your down payment is under:",
          options: ["10%", "15%", "20%", "25%"],
          correctIndex: 2,
        },
        {
          id: "pf-u9-L15-SQ3",
          question: "Closing costs typically run:",
          options: ["1%", "2-5%", "10%", "15%"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ4",
          question: "An ARM is a mortgage with:",
          options: ["Fixed rate", "Adjustable rate", "No rate", "Government rate"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ5",
          question: "A REIT lets you invest in real estate through:",
          options: ["Buying land", "The stock market", "A bank loan", "A lease"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ6",
          question: "Pre-approval tells you:",
          options: ["The exact house price", "How much a lender will loan you", "Your closing date", "Your property tax"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ7",
          question: "Equity is the difference between:",
          options: ["Rent and mortgage", "Home value and loan balance", "Income and expenses", "Asking price and offer"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ8",
          question: "Refinancing means:",
          options: ["Selling your home", "Replacing your mortgage with a new one", "Paying off your mortgage early", "Getting a second home"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ9",
          question: "Property taxes are based on:",
          options: ["Your income", "Assessed property value", "Your mortgage rate", "Square footage only"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ10",
          question: "House hacking means:",
          options: ["Flipping houses", "Living in part, renting out the rest", "Buying foreclosures", "Renovating cheaply"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ11",
          question: "The 28/36 rule limits housing costs to _____ of gross income:",
          options: ["20%", "28%", "36%", "50%"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ12",
          question: "An escrow account holds money for:",
          options: ["Savings", "Taxes and insurance", "Your down payment", "Renovation costs"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ13",
          question: "A home inspection checks for:",
          options: ["Market value", "Structural and safety issues", "Neighborhood quality", "Resale potential"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ14",
          question: "FHA loans require as little as _____ down:",
          options: ["0%", "3.5%", "10%", "20%"],
          correctIndex: 1,
        },
        {
          id: "pf-u9-L15-SQ15",
          question: "Homes historically appreciate about:",
          options: ["1% per year", "3-4% per year", "10% per year", "15% per year"],
          correctIndex: 1,
        },
      ],
    },
