...
export const lesson1: Lesson = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        'Conduction between adjacent water molecules in the pot',
        'Radiation emitted from the hot inner pot walls',
        'Natural convection \u2014 buoyancy-driven circulation of hot and cold water',
        'Forced convection generated by a built-in impeller mechanism',
      ],
...
export const lesson2: Lesson = {
  ...
  questions: [
    ...
    // --- SUSPENSION (Q5-Q7) ---
    {
      ...
      options: [
        'Support the static weight of the car on each wheel',
    ...
    },
    {
      ...
      options: [
        'Front brake pads are made with a higher friction coefficient material',
        'The normal force N on the front tires increases due to weight transfer',
        'The front wheels spin faster than the rear wheels during braking',
        'The front tires have a larger contact patch area by factory design',
      ],
    ...
    // --- TRANSMISSION (Q11-Q13) ---
    {
      ...
      options: [
        ...
        'A small engine gear drives a large output gear, multiplying torque',
        'The clutch slips more in first gear, adding additional torque',
    ...
    // --- TIRES (Q14-Q16) ---
    {
      ...
      options: [
        '20 cm\u00B2 — roughly the area of a coin',
        '200 cm\u00B2 — roughly the area of a postcard',
        '2000 cm\u00B2 — roughly the area of a newspaper',
        '2 cm\u00B2 — roughly the area of a fingertip',
      ],
    ...
    },
    {
      ...
      options: [
        'Water lubricates the rubber, reducing the friction coefficient to nearly zero',
        'A wedge of water builds faster than the tread can channel it away, lifting the tire',
        'Water increases tire temperature through friction, causing the rubber to melt',
        'The water freezes under contact pressure, creating a thin ice layer beneath the tire',
      ],
    ...
    // --- STEERING (Q17-Q18) ---
    {
      ...
      options: [
        ...
        'Pressurized hydraulic fluid acting on a piston in the rack',
        'A planetary gear reducer between the wheel and the rack',
        'Reduced friction from ceramic steering knuckle bearings',
      ],
    ...
    },
    {
      ...
      options: [
        ...
        'The inner wheel turns more than the outer, so all wheels share a common turn center',
        'The rear wheels also turn slightly to reduce the turning radius',
        'The steering gear ratio automatically changes with vehicle speed',
      ],
