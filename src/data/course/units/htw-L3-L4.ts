...
export const lesson3: Lesson = {
  ...
  <text x="40" y="74" font-size="4" fill="#6B7280" text-anchor="middle">centrifugal direction</text>
    ...
    },
    {
      ...
      options: [
        'Shear stress from differential heating across the glass thickness',
        'Compressive thermal stress — the glass wants to expand but cannot',
        'Tensile stress pulling the glass pane away from the rigid frame',
        'Torsional stress twisting the glass pane about its center axis',
      ],
...
export const lesson4: Lesson = {
  ...
  <text x="40" y="73" font-size="4" fill="#334155" text-anchor="middle">P = F&#x2081;/A&#x2081; = F&#x2082;/A&#x2082;</text>
    ...
    },
    {
      ...
      options: [
        'Oil has a lower viscosity than air, significantly reducing friction losses',
        'Oil is nearly incompressible, transmitting pressure instantly without loss',
        'Oil is lighter than water, reducing the overall weight of the system',
        'Oil has higher thermal conductivity, preventing system overheating',
      ],
  ...
  <text x="40" y="73" font-size="4" fill="#334155" text-anchor="middle">1st-class lever</text>
    ...
    // --- SCREWDRIVER ---
    {
      ...
      options: [
        ...
        'A larger diameter provides a longer moment arm, increasing torque',
        'The larger handle reduces the friction within the screw threads',
        'The larger handle increases the rotational speed of the fastener',
      ],
    ...
    // --- LEVEL (SPIRIT LEVEL) ---
    {
      ...
      options: [
        'Surface tension pulls the bubble toward the geometric center of the vial',
        'Buoyancy — the less-dense air bubble floats to the highest point in the vial',
        'Magnetic forces within the liquid align the bubble with Earth\'s field',
